            ...
            <div className="container">
                <div  style={{backgroundColor: bgColor}}  className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white rounded-3xl">
                    ...
                    <div className="p-6 sm:p-8">
                        ...
                        <h1 className="text-4xl lg:text-7xl font-bold uppercase">{title}</h1>
                        <p className="text-sm">{date}</p>
                    </div>
                    {/* second col */}
                    <div className="h-full flex items-center">
                        <img src={image} alt="headphone" className="scale-125 w-[250px] md:w-[340px] mx-auto drop-shadow-2xl object-cover"/>
                    ...
                    <div className="flex flex-col justify-center gap-4 p-6 sm:p-8">
                        ...
                        <div>
                            <button  style={{color: bgColor}} className="bg-white py-2 px-4 rounded-full">Shop Now</button>
                        </div>
                    </div>
                </div>
            </div>
